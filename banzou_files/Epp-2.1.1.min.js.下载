...
/* */
$('.head-nav-menu ul li').hover(function(){
	$(this).find('.head-nav-slide').stop().slideDown();
	$(this).find('.head-slide-all').stop().slideDown();
},function(){
	$(this).find('.head-nav-slide').stop().slideUp();
	$(this).find('.head-slide-all').stop().slideUp();
})